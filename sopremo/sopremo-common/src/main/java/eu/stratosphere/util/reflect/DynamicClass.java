...
public class DynamicClass<DeclaringClass> {
	...
	public Object invoke(final DeclaringClass instance, final String name, final Object... params) throws Throwable {
		return this.getMethod(name).invoke(instance, params);
	}

	public Object invokeStatic(final String name, final Object... params) throws Throwable {
	...
	public DeclaringClass newInstance(final Object... params) throws Throwable {
