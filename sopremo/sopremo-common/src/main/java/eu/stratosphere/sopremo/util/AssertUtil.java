...
public class AssertUtil {
	...
	public static <T> void assertIteratorEquals(Iterator<? extends T> expectedIterator,
			Iterator<? extends T> actualIterator, eu.stratosphere.sopremo.util.Equaler<T> equaler) {
	...
	public static <T> void assertIteratorEquals(Iterator<? extends T> expectedIterator,
		...
		assertIteratorEquals(null, expectedIterator, actualIterator, eu.stratosphere.sopremo.util.Equaler.JavaEquals);
	}
