...
public class TypeCoercer {
	...
	private Map<Class<? extends IJsonNode>, Coercer<?, IArrayNode>> getToArrayCoercers() {
		...
		toArrayCoercers.put(IJsonNode.class, new Coercer<IJsonNode, IArrayNode>(ArrayNode.class) {
			@Override
			public IArrayNode<IJsonNode> coerce(final IJsonNode from, final IArrayNode target) {
				target.clear();
				target.add(from);
				return target;
			}
		...
		toArrayCoercers.put(IArrayNode.class, new Coercer<IArrayNode, IArrayNode>(ArrayNode.class) {
			@Override
			public IArrayNode<IJsonNode> coerce(final IArrayNode from, final IArrayNode target) {
				target.clear();
				target.addAll(from);
				return target;
			}
		...
		toArrayCoercers.put(IObjectNode.class, new Coercer<IObjectNode, IArrayNode>(ArrayNode.class) {
			@Override
			public IArrayNode<IJsonNode> coerce(final IObjectNode from, final IArrayNode target) {
				target.clear();
