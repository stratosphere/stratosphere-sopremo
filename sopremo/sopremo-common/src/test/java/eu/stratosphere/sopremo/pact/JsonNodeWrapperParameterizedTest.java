...
//	private final byte[] target2;
	...
	public JsonNodeWrapperParameterizedTest(final IJsonNode node1, final IJsonNode node2, final boolean shouldBeEqual) {
		this.wrapper1 = new JsonNodeWrapper(node1);
		this.wrapper2 = new JsonNodeWrapper(node2);
...
//
//		Assert.assertEquals(this.target1[0], (byte) this.wrapper1.getValue().getType().ordinal());
//		Assert.assertEquals(this.target2[0], (byte) this.wrapper2.getValue().getType().ordinal());
//	}
//
//	@Test
