...
public class GeneralSchemaTest {
	...
	private ArrayNode<IJsonNode> array;
	...
	public void setUp() {
		...
		this.array = new ArrayNode<IJsonNode>(IntNode.valueOf(3), IntNode.valueOf(4));
	...
	public void shouldCreateACorrectRecord() {
		...
		this.schema.jsonToRecord(this.array, record);
	...
	public void shouldReturnTheCorrectNode() {
		...
		record.setField(2, new JsonNodeWrapper(this.array));

		Assert.assertSame(this.array, this.schema.recordToJson(record));
	}
}
