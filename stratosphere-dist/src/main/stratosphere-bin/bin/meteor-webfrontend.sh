...
case $STARTSTOP in
		...
		$JAVA_HOME/bin/java $JVM_ARGS $log_setting -classpath $PACT_WF_CLASSPATH eu.stratosphere.meteor.client.WebFrontend -configDir $NEPHELE_CONF_DIR &
		echo $! > $pid
	;;
